          ...
          <table cellpadding="0" cellspacing="0" width="100%" style="margin: 24px 0; border-collapse: separate; border-spacing: 0 8px;">
            ...
            ${
              ...
              <td style="text-align: right; font-size: 14px;">
                ...
                <span style="color: rgba(148, 163, 184, 0.8); font-size: 12px;">${[
            ...
            ${
              ...
              <td style="text-align: right; font-size: 14px;">
                ...
                <span style="color: rgba(148, 163, 184, 0.8); font-size: 12px;">${[
                  ...
                  receipt.stay.checkIn && `Check-in ${receipt.stay.checkIn}`,
                  receipt.stay.checkOut && `Check-out ${receipt.stay.checkOut}`,
                ]
                  .filter(Boolean)
                  .join(" · ")}</span>
              </td>
